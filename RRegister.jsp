...
<%
				...
				try {
						...
						while (params.hasMoreElements()) 
						{
							...
							{
								group=multi.getParameter(paramname);
							}
					...
					if ( rs1.next() )
					   {
								...
								out.print("Receiver Name Already Exits");							%>
							<p><a href="ReceiverRegister.jsp">Back</a>         <a href="index.html">Home</a> </p>
					...
					//		ps.setString(11,sk);		
							...
							{		
								...
								%>
								<p><a href="ReceiverLogin.jsp">Back</a>         <a href="index.html">Home</a> </p>
								<%
							}
						}
} 
