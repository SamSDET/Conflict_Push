...
<head>
<title>Cloud Server(View Senders SDI)</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View All Sender(Owners) </span>:</h2>
          <p>&nbsp;</p>
          <table width="406" border="1" align="center">
            <tr>
              ...
              <td width="135" bgcolor="#FF0000"><div align="center" class="style26">Owner Name </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
              <td><div class="style24">
                  <div align="center"><a href="c_SDIstatus.jsp?id=<%=i%>"><%=s5%></a></div>
              </div></td>
              <%
