...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View All Owner SK for Corresponding Files : </h2>
          <p>&nbsp;</p>
          <table width="542" border="1" align="center">
            <tr>
              <td width="88" height="30" bgcolor="#FF0000"><div align="center" class="style26"> ID </div></td>
              <td width="128" bgcolor="#FF0000"><div align="center" class="style26">Owner Name </div></td>
              <td width="155" bgcolor="#FF0000"><div align="center" class="style26">File Name </div></td>
              <td width="143" bgcolor="#FF0000"><div align="center" class="style26">PKey1</div></td>
              <td width="143" bgcolor="#FF0000"><div align="center" class="style26">PKey2</div></td>
              <%	  
