...
<head>
<title>Cloud Server(View Receivers SDI)</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View All Receiver(Users) </span>:</h2>
          <p>&nbsp;</p>
          <table width="406" border="1" align="center">
            <tr>
              <td width="76" height="30" bgcolor="#FF0000"><div align="center" class="style21 style25"><strong>User ID </strong></div></td>
              <td width="135" bgcolor="#FF0000"><div align="center" class="style26">Users Name </div></td>
              <td width="161" bgcolor="#FF0000"><div align="center" class="style26">Fog Status </div></td>
              <%	  
	...
	while ( rs.next() )
	   {
		...
		%>
              <td><div class="style24">
                  <div align="center"><a href="c_SDIstatusReceiver.jsp?id=<%=i%>"><%=s5%></a></div>
              </div></td>
              <%
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="c_ViewSendersSDI.jsp"><span>View All Sender(Owners)I </span></a></li>
