...
<head>
<title>Receiver(SK Response)</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View Secret Key Response  :  </h2>
          <p>&nbsp;</p>
        ...
        <input type="submit" name="Submit" value="Find Secret Key" />
            ...
            <p align="center" class="style19"><span class="style20">Secret Key :</span> <%=application.getAttribute("key")%>&nbsp;</p>
          </form>
          <p>&nbsp;</p>
          <div class="clr"></div>
        </div>
