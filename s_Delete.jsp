      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="637" border="1" align="center">
            <tr>
              <td width="71" height="30" bgcolor="#FF0000"><div align="center" class="style21 style27"><strong>User ID </strong></div></td>
              <td width="113" bgcolor="#FF0000"><div align="center" class="style28">File Name </div></td>
              <td width="196" bgcolor="#FF0000"><div align="center" class="style28">Uploaded Date &amp; Time </div></td>
              <td width="107" bgcolor="#FF0000"><div align="center" class="style28">Data Owner </div></td>
              <td width="116" bgcolor="#FF0000"><div align="center" class="style28">Delete File </div></td>
              <%	  
...
try 
	{
            ...
            <tr>
              ...
              <td><div align="center" class="style29"><%=dt%></div></td>
              <td><div align="center" class="style29"><%=s4%></div></td>
              <td><div class="style29">
                  <div align="center"><a href="s_Delete1.jsp?usid=<%=i%>">Delete</a></div>
              </div></td>
              <%
...
%>
          ...
          <h2><%=application.getAttribute("msg")%>!!</h2></p>
          <a href="SenderMain.jsp">Back</a>
          <p>&nbsp;</p>
          <div class="clr"></div>
        </div>
        <p class="pages">&nbsp;</p>
