...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Verify Files </span>  :  </h2>
          <p>&nbsp;</p>
          <table width="658" border="1" align="center">
            <tr>
              <td width="47" height="30" bgcolor="#FF0000"><div align="center" class="style21 style24"><strong> ID </strong></div></td>
              <td width="108" bgcolor="#FF0000"><div align="center" class="style25">File Name </div></td>
              <td width="123" bgcolor="#FF0000"><div align="center" class="style25">Data Owner </div></td>
              <td width="116" bgcolor="#FF0000"><div align="center" class="style25">Date &amp; Time </div></td>
              <td width="125" bgcolor="#FF0000"><div align="center" class="style25">File Status </div></td>
              <%	  
...
try 
	{
            ...
            <tr>
              ...
              <td> <div align="center" class="style26"><a href="s_RecoverFiles1.jsp?fname=<%=s2%>">Audit from Fog..</a></div></td>
...
%>
          ...
          <p>&nbsp;</p>
          <p class="infopost"><a href="SenderMain.jsp">Back</a></p>
          <div class="clr"></div>
          <div class="img"></div>
          <div class="clr"></div>
        </div>
