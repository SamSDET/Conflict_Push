...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from sender  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("Sender Name Already Exits");							
							%>
							<p><a href="SenderRegister.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
					   PreparedStatement ps=connection.prepareStatement("insert into sender(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?)");
			...
			%>
			<p><a href="SenderLogin.jsp">Back</a>         <a href="index.html">Home</a> </p>
