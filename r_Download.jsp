        ...
        <div class="article">
          ...
          <form action="r_Download1.jsp" method="post" name="form1" id="form1">
            <table width="473" border="0" align="center">
              ...
              <tr>
                <td height="34" bgcolor="#FF0000"><span class="style7">HMAC :-</span></td>
                <td><input name="t12" type="text" size="40" /></td>
              </tr>
              <tr>
                <td bgcolor="#FF0000"><span class="style7">Secret Key :-</span></td>
              ...
              <tr>
                <td><div align="right">
                    <input type="submit" name="Submit" value="Request Credentials" />
                </div></td>
                <td><label>
          ...
          <p><a href="ReceiverMain.jsp">Back</a>
          </p>
          <div class="clr"></div>
          <div class="img"></div>
          <div class="clr"></div>
