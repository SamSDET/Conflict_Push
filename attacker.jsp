    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Attack Files </h2>
          <p class="infopost">&nbsp;</p>
          <form id="form1" name="form1" method="post" action="a_Update1.jsp">
            <label> </label>
            <table width="553" border="0" align="center">
              <tr>
                <td bgcolor="#FF0000" class="odd style14 style28"><span class="odd style11 style16">Enter File Name :</span> </td>
            ...
            <div align="center"><br />
              <br />
              <input align="right" type="submit" name="Submit" value="View File" />
            </div>
            </label>
          </form>
          <p class="infopost">&nbsp;</p>
