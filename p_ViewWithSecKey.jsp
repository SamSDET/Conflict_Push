...
<head>
<title>Private Key Generator(View)</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View All Files With Secret Key : </h2>
          <p>&nbsp;</p>
          <table width="582" border="1" align="center">
            <tr>
              <td width="48" height="30" bgcolor="#FF0000"><div align="center" class="style21 style24"><strong> ID </strong></div></td>
              <td width="99" bgcolor="#FF0000"><div align="center" class="style25">User Name </div></td>
              <td width="98" bgcolor="#FF0000"><div align="center" class="style25">PKey1</div></td>
              <td width="99" bgcolor="#FF0000"><div align="center" class="style25">PKey2</div></td>
              <td width="102" bgcolor="#FF0000"><div align="center" class="style25">Owner Name </div></td>
              <td width="96" bgcolor="#FF0000"><div align="center" class="style25">File Name </div></td>
              <%	  
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              ...
              <td><div align="center" class="style27"><%=s7%></div></td>
