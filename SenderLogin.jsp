  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Sender Login :  </h2>
          <form action="SenderAuthentication.jsp" method="post" id="leavereply">
            <label for="name"><br />
              <span class="style2">Name (required)<br />
              </span></label>
            <span class="style2">
            ...
            <p><span class="style2">New user ? click here to</span> <a href="SenderRegister.jsp"> Register</a></p>
          </form>
          <p align="justify"><a href="index.html">Back</a></p>
          <div class="clr"></div>
          <div class="img"></div>
          <div class="clr"></div>
        </div>
