...
<head>
<title>Cloud Server(Transactions)</title>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="602" border="1" align="center">
            <tr>
              <td width="104" height="31" bgcolor="#FF0000"><div align="center" class="style22 style24">User ID </div></td>
              ...
              <td width="171" bgcolor="#FF0000"><div align="center" class="style25">Task</div></td>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><span class="style23"><a href="c_ViewResults.jsp">View Results </a></span></li>
